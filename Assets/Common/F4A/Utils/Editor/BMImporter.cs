...
public class F4ABitmapFontEditor
{
    [MenuItem("Assets/F4A/Bitmap Font/Import from text file")]
    ...
    [MenuItem("Assets/F4A/Bitmap Font/Import from texture meta")]
