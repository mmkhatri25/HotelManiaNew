namespace com.F4A.MobileThird
{
    ...
    public class SaveLoadDataManager : SingletonMono<SaveLoadDataManager>
    {
        ...
        public void SaveData(string databaseName, bool isAuth = true)
        {
            var data = _dataController.GetData();
            FirebaseManager.Instance.SaveDatabase(databaseName, data.ToString(), isAuth: isAuth);
        }
