    ...
    public class AudioManager : SingletonMonoDontDestroy<AudioManager>
    {
        ...
        public bool IsEnableMusic
        {
            ...
            set
            {
               ...
               //PlayerPrefs.SetBool(DMCMobileUtils.KeyMusic, isEnableMusic);
        ...
        public bool IsEnableVibrate
        {
            ...
            set
            {
               ...
               //PlayerPrefs.SetBool(DMCMobileUtils.KeyVibrate, value);
        ...
        {
            //EnableSfx = CPlayerPrefs.GetBool(DMCMobileUtils.KeySfx, true);
          //IsEnableMusic = CPlayerPrefs.GetBool(DMCMobileUtils.KeyMusic, true);
           //sEnableVibrate = CPlayerPrefs.GetBool(DMCMobileUtils.KeyVibrate, true);
        }
