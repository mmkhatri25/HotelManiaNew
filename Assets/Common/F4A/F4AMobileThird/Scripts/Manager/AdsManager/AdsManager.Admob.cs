...
namespace com.F4A.MobileThird
{
    public partial class AdsManager
    {
        ...
        {
            _tweenInterstitialAdmob = DOVirtual.DelayedCall(adConfigData.timeDelayRequestAdFull, () => { RequestInterstitialAdmob(); });
        ...
        private void RewardedAd_OnAdFailedToShow(object sender, AdErrorEventArgs e)
        {
            ...
            OnRewardedAdFailed?.Invoke(ERewardedAdNetwork.AdMob, e.Message);
            RequestRewardAdmob();
        }
        ...
        private void RewardedAd_OnAdFailedToLoad(object sender, AdErrorEventArgs e)
        {
            ...
            _tweenRewardAdmob = DOVirtual.DelayedCall(adConfigData.timeDelayRequestAdReward, () => { RequestRewardAdmob(); });
        }
        ...
        private Tween _tweenRequestBannerAdmob = null;
        private bool _isRequestBannerAdmobSuccess = false;
        private void RequestBannerAdmob()
        {
#if DEFINE_ADMOB
            _tweenRequestBannerAdmob.Reset();
            _isRequestBannerAdmobSuccess = false;
        ...
        {
            _tweenRequestBannerAdmob = DOVirtual.DelayedCall(adConfigData.timeDelayRequestAdBanner, () => { RequestBannerAdmob(); });
        }
#endif
        ...
        private void BannerViewAdmob_OnAdLoaded(object sender, EventArgs e)
        {
            ...
            _isRequestBannerAdmobSuccess = true;
        }
        ...
        protected bool ShowBannerAdAdmob()
        {
            ...
            if (IsEnableAdmobAd())
            {
                if (bannerViewAdmob != null && _isRequestBannerAdmobSuccess)
                {
