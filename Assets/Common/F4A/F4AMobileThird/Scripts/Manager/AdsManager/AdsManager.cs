    ...
    public class AdmobConfigData
    {
        ...
        private DMCAdmobAppInfo[] _androidAppInfos = new DMCAdmobAppInfo[1]
        {
            new DMCAdmobAppInfo()
            {
                ...
                NativeAdvancedVideoId = "ca-app-pub-3940256099942544/1044960115"
            }
        };
        ...
        private DMCAdmobAppInfo[] _iosAppInfos = new DMCAdmobAppInfo[1]
        {
            new DMCAdmobAppInfo()
            {
                ...
                NativeAdvancedVideoId = "ca-app-pub-3940256099942544/2521693316"
            }
        };
...
#region MobPub
    ...
    public class AdConfigData
    {
        ...
        [Header("Config")]
        public int counterIntervalShowInterstitial = 1;
        [Tooltip("Seconds Interval show Interstitial")]
        public int timeIntervalInterstitial = 15;
        public bool isShowBannerAd = false;
        public int timeDelayRequestAdReward = 10;
        public int timeDelayRequestAdBanner = 10;
        public int timeDelayRequestAdFull = 10;
    }
    ...
    public partial class AdsManager : SingletonMono<AdsManager>, IAdsManager
    {
...
#pragma warning disable 414
        ...
        /// <summary>
        /// ERewardedAdNetwork, error
        /// </summary>
        public static event Action<ERewardedAdNetwork, string> OnRewardedAdFailed = delegate { };
        public static event Action<ERewardedAdNetwork> OnRewardedAdLoaded = delegate { };
        public static event Action<ERewardedAdNetwork> OnRewardedAdOpened = delegate { };
        public static event Action<ERewardedAdNetwork> OnRewardedAdStarted = delegate { };
        public static event Action<ERewardedAdNetwork> OnRewardedAdLeftApplication = delegate { };
        ...
        public static event Action<EInterstitialAdNetwork> OnInterstitialAdLeftApplication = delegate { };
        public static event Action<EInterstitialAdNetwork> OnInterstitialAdLoaded = delegate { };
        public static event Action<EInterstitialAdNetwork> OnInterstitialAdOpened = delegate { };



        public static event Action<EBannerAdNetwork> OnBannerAdLoad = delegate { };
        public static event Action<EBannerAdNetwork> OnBannerAdClosed = delegate { };
        public static event Action<EBannerAdNetwork> OnBannerAdOpened = delegate { };
        public static event Action<EBannerAdNetwork> OnBannerAdFailedToLoad = delegate { };
        public static event Action<EBannerAdNetwork> OnBannerAdLeftApplication = delegate { };
...
#region Unity Method
        ...
        private void AdsManager_OnRewardedAdFailed(ERewardedAdNetwork adNetwork, string error)
        {
            ...
            {
                {"ads_network", adNetwork.ToString() },
                {"status","failed" },
                {"error", error  }
            });
        }
...
#region Interstitial Ads
        ...
        public bool IsInterstitialAdsReady()
        {
            try
            {
                if ( !IsEnalbleAds())
                    return false;
                if (Time.realtimeSinceStartup - lastTimeShowInterstital < adConfigData.timeIntervalInterstitial
                    || countEventShowInterstitial + 1 < adConfigData.counterIntervalShowInterstitial)
                    return false;
        ...
        public bool ShowInterstitialAds(int adsInterval = -1, Action onInterstitialClose = null, string locationId = "", EInterstitialAdNetwork[] adNetworks = null)
        {
            ...
            if(adsInterval > 0)
            {
                adConfigData.timeIntervalInterstitial = adsInterval;
            }
...
#region Video Ads
	    ...
	    private void SetRemoveAds(bool isRemoveAd)
        {
           ...
           //PlayerPrefs.SetBool(DMCMobileUtils.KeyRemoveAds, isRemoveAd);
            if (isRemoveAd)
            {
                DestroyBannerAds();
